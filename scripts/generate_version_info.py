...
FILE_DESCRIPTION = "Battlezone Gold Extractor"
INTERNAL_NAME = "BZGoldExtractor"
ORIGINAL_FILENAME = "BZGoldExtractor.exe"
...
def main() -> None:
    ...
    parser.add_argument("--version", required=True, help="Release version, for example 1.1.0 or v1.1.0")
